            ...
            for user in users:
                ...
                for cmdb_id in cmdb_ids:
                    if CMDB_REPORT in report_item_list:
                        ...
                        cmdb_overview = GetOverViewBase().get_overview(session, cmdb_id, task_record_id,
                                                                       user.login_user)
                    ...
                    if RISK_SQL_REPORT in report_item_list:
                        ...
                        risk_rule_outer, cmdb_id, task_record_id_list = GetRiskRuleBase().get_risk_rule(session,
                                                                                                        **params)
                    ...
                    if RISK_OBJ_REPORT in report_item_list:
                        ...
                        risk_rule_outer, cmdb_id, task_record_id_list = GetRiskRuleBase().get_risk_rule(session,
                                                                                                        **params)
                        risk_rule_obj_inner = RiskRuleObj().get_risk_obj(cmdb_id=cmdb_id,
                    ...
                    if SCHEMA_REPORT in report_item_list:
                        ...
                        for schema in schemas:
                            params = {"cmdb_id": cmdb_id, "tri": task_record_id, "schema_name": schema}
