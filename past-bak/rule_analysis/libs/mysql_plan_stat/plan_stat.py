...
import past.rule_analysis.libs.mysql_plan_stat.json_plan_parse
...
class MysqlPlanOrStat(object):
    ...
    def __init__(self, pt_query_client, db_client, mongo_client, rule_type):
        self.pt_query_client = pt_query_client
    ...
    def get_pt_query_sql(self, start_date, stop_date, schema, hostname):
        ...
        result = self.pt_query_client.execute(sql)
        # self.pt_query_client.close()
        return result
    ...
    def get_sql_plan(self, user, passwd):
        ...
        for sqlinfo in sqlinfos:
            ...
            past.rule_analysis.libs.mysql_plan_stat.json_plan_parse.json_plan_item(
