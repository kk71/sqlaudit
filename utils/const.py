...
# dashboard上面四个类型数据下钻用的标识

DASHBOARD_STATS_NUM_SQL = "SQL"
DASHBOARD_STATS_NUM_TAB = OBJ_RULE_TYPE_TABLE
DASHBOARD_STATS_NUM_INDEX = OBJ_RULE_TYPE_INDEX
DASHBOARD_STATS_NUM_SEQUENCE = OBJ_RULE_TYPE_SEQ
ALL_DASHBOARD_STATS_NUM_TYPE = (
    DASHBOARD_STATS_NUM_SQL,
    DASHBOARD_STATS_NUM_TAB,
    DASHBOARD_STATS_NUM_INDEX,
    DASHBOARD_STATS_NUM_SEQUENCE
)
