...
class OraclePlanOrStat(object):
    ...
    def __init__(self, mongo_client, username, capture_date, record_id):
        """
        """
    ...
    def query_sql_plan(self, sql_id, hash_value):
        ...
        sql = {
            ...
            # "ETL_DATE": {"$gte": self.capture_date}
    ...
    def execute(self, rule_type, temp_data, rule_cmd_attach, obj_type,
        ...
        for sql in data:
            ...
            if rule_type == "SQLPLAN":
                ...
                temp_obj.extend([sql_id, hash_value, self.username, object_name, sql["ID"], sql["COST"], sql["COUNT"]])
