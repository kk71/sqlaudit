...
class PyH(Tag):
    ...
    def __init__(self, name='MyPyHPage'):
        ...
        self.head += meta(**{'http-equiv': "Content-Type", 'content': "text/html;charset=utf-8"}).render()
...
if __name__ == "__main__":
    ...
    page << link(rel_abc='stylesheet', type='text/css', href="www.baidu.com")
    meta(**{'http-equiv': "Content-type", 'content': "text/html;charset=utf-8"}).render()
    # page <<
    # page.printOut()
