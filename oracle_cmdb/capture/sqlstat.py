...
class SQLStat(TwoDaysSQLCapturingDoc):
    ...
    parsing_schema_name = StringField(required=True)
    module = StringField(required=True)
    cpu_time_total = FloatField(required=True)
    cpu_time_delta = FloatField(required=True)
    per_cpu_time = FloatField(required=True)
    disk_reads_total = FloatField(required=True)
    disk_reads_delta = FloatField(required=True)
    per_disk_reads = FloatField(required=True)
    direct_writes_total = FloatField(required=True)
    direct_writes_delta = FloatField(required=True)
    per_direct_writes = FloatField(required=True)
    elapsed_time_total = FloatField(required=True)
    elapsed_time_delta = FloatField(required=True)
    per_elapsed_time = FloatField(required=True)
    buffer_gets_total = FloatField(required=True)
    buffer_gets_delta = FloatField(required=True)
    per_buffer_gets = FloatField(required=True)
    rows_processed_delta = IntField(required=True)
    rows_processed_total = IntField(required=True)
    rows_processed_gets = IntField(required=True)
    executions_total = IntField(required=True)
    executions_delta = IntField(required=True)
    per_row_blk = FloatField(required=True)
