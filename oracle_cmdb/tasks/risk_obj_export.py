...
class RiskRuleObjExport(BaseTask):
    ...
    def report(cls, path_prefix, filename, **kwargs):
        ...
        a = 0
        risk_rule_outer = parame_dict.pop("risk_rule_outer")
        risk_rule_obj_inner = parame_dict.pop("risk_rule_obj_inner")
    ...
    def task(cls, task_record_id: int, **kwargs):
        ...
        with make_session() as session:
            ...
            risk_rule_obj_inner = RiskRuleObj(). \
                get_risk_obj(cmdb_id=cmdb_id, task_record_id_in=task_record_id_list)
