...
ALL_RULE_ENTRIES = (
    ...
    RULE_ENTRY_ONLINE_DB_LINK := "OBJECT_DB_LINK",
    RULE_ENTRY_ONLINE_TRIGGER := "OBJECT_TRIGGER",
    RULE_ENTRY_ONLINE_VIEW := "OBJECT_VIEW",
    RULE_ENTRY_ONLINE_PROCEDURE := "OBJECT_PROCEDURE",
    RULE_ENTRY_ONLINE_FUNCTION := "OBJECT_FUNCTION",
